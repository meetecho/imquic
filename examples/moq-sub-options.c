...
gboolean demo_options_parse(demo_options *options, int argc, char *argv[]) {
	...
	GOptionEntry opt_entries[] = {
		...
		{ "end-group", 'G', 0, G_OPTION_ARG_INT64, &options->end_group, "Group to end at, for Standalone FETCH or when using specific filters in SUBSCRIBE (default=maximum)", "id" },
